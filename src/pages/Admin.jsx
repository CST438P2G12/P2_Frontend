        ...
        <div className="page">
            ...
            <div className="page-content fade-up">
                ...
                <p className="page-subtitle" style={{marginBottom: '32px'}}>
                    Manage all user accounts. {!loading &&
                ...
                <div className="card">
                    ...
                    {editingUser?.id === u.id ? (
                        ...
                        <>
                            ...
                            <button className="btn btn-danger" onClick={() => setConfirmDeleteId(u.id)}
                                    style={{fontSize: '0.8rem', padding: '6px 14px'}}>
                                Delete
                            </button>
                        </>
                                    ...
                                    <div className="user-info-panel">
                                        ...
                                        <div className="user-info-grid">
                                            ...
                                            <div className="user-info-item">
                                                ...
                                                <span
                                                    className="user-info-value">{u.admin ? 'Administrator' : 'Regular User'}</span>
                                            </div>
                                            <div className="user-info-item">
                                        ...
                                        {confirmDeleteId === u.id && (
                                            <div className="confirm-delete-panel">
                                                <p className="confirm-text">⚠️ Permanently
                                                    delete <strong>{u.name}</strong> and all their data?</p>
                                                <div className="confirm-buttons">
                                                    <button className="btn btn-danger"
                                                            onClick={() => handleDelete(u.id)}>Yes, Delete
                                                    </button>
